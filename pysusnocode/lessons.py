...
SEED_LESSONS = [
    ...
    "pysus.mask_data() e unmask_data() quebram com ModuleNotFoundError: No module named 'cryptography' — a pysus usa a biblioteca sem declara-la, exatamente como faz com o pyyaml. Neste aplicativo funciona (embarcamos cryptography); no Colab e preciso '%pip install cryptography' antes. Quando funcionam, entregam o que prometem: method='encrypt' e reversivel com a chave devolvida, 'hash' e de mao unica, 'redact' vira ***, e as colunas nao listadas ficam intactas. Sao uteis para compartilhar um recorte sem levar junto CNS ou outro identificador.",
